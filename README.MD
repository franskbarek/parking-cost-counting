...
#### Inisialisasi seluruh `node module` pakages sebelum menjalankan aplikasi
...
- Get all data menggunakan method **`GET`** _http://localhost:5000/api/_
- Insert data menggunakan method **`POST`** _http://localhost:5000/api/adding_
